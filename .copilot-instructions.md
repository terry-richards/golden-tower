...
> **Note — No Accessory Notches**: The outer cylindrical body of each segment must be **clean and smooth** — no alignment notches, grip features, or accessory slots on the exterior. All alignment is handled by the internal interlock geometry.
...
- Ensures the outer segment body is **clean and smooth** — no accessory
  notches, grip textures, or external alignment features.
